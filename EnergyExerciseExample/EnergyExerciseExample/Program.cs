...
namespace EnergyExerciseExample
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                Console.WriteLine("Enter Energy and Exercise Count (Int only) separated by space. :");
                ...
                Console.WriteLine("Enter Energy drain per Exercise Count (Int only) separated by space. :");
            ...
            else
            {
                ...
                foreach (int k in sorted)
                {
                    for (int i = 0; i < 2; i++)
                    {
                        ...
                        if (N <= 0)
                        {
                            Console.WriteLine($"Total exercises done: {cnt}");
                            return;
                        }
                    }
                    if (N <= 0)
                ...
                if (N > 0)
                {
                    Console.WriteLine("Total exercises done: -1");
                    return;
                }
            }
        }
